...
url: https://docs.kognitos.com/books/reference-docs/googledocs/concepts
description: Concepts used in Google Docs book.
---
...
### hashtagGoogle drive file reference
...
### hashtagGoogle drive folder reference
