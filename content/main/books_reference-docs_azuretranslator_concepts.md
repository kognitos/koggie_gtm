...
url: https://docs.kognitos.com/books/reference-docs/azuretranslator/concepts
description: Concepts used in Azure Translator book.
---

# Concepts | Books | Kognitos Documentation

The following documentation is forAzure Translator v1.3.2(BDK).

### hashtagAzure file reference
