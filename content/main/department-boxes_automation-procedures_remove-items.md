---
title: Remove Items | Department Boxes | Kognitos Documentation
url: https://docs.kognitos.com/department-boxes/automation-procedures/remove-items
description: Removes all items from a department box.
---

# Remove Items | Department Boxes | Kognitos Documentation

### hashtagOverview

This procedure is used to remove items from a department box(a storage unit within an agent).
...
Specifies items to remove from the department box.
