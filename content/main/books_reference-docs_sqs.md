---
title: AWS SQS | Books | Kognitos Documentation
url: https://docs.kognitos.com/books/reference-docs/sqs
description: Overview of the AWS SQS book.
---

# AWS SQS | Books | Kognitos Documentation
