---
title: AWS Secrets Manager | Books | Kognitos Documentation
url: https://docs.kognitos.com/books/reference-docs/secretsmanager
description: Overview of the AWS Secrets Manager book.
---

# AWS Secrets Manager | Books | Kognitos Documentation
...
### hashtagConnect using AWS Access key ID, AWS Secret Access Key, AWS Region, AWS Role ARN and AWS External ID
...
### hashtagConnect using AWS Access key ID, AWS Secret Access Key and AWS Region
