---
title: AWS S3 | Books | Kognitos Documentation
url: https://docs.kognitos.com/books/reference-docs/s3
description: Overview of the AWS S3 book.
---

# AWS S3 | Books | Kognitos Documentation
